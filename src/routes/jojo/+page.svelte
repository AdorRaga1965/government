	...
	const menuGroups = [
		...
		},
		{
			...
			items: [
				...
				{ label: 'Vehicles API', path: '/Vehicles API.html', icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5"><path fill-rule="evenodd" d="M10.832 2.222a1.5 1.5 0 0 1 2.336 0l5.25 6.75a1.5 1.5 0 0 1-.918 2.528H2.5a1.5 1.5 0 0 1-.918-2.528l5.25-6.75ZM10 12.5a.75.75 0 0 1 .75.75v3.5a.75.75 0 0 1-1.5 0v-3.5a.75.75 0 0 1 .75-.75Z" clip-rule="evenodd" /></svg>`},
